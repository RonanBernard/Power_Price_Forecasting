...
This script processes the data for the v3 model.
...
def create_windows(
    ...
    with open(MODELS_PATH / 'v3' / 'features_info.json', 'w') as f:
...
def main(
    ...
    data_model_dir = data_dir / 'v3'
    data_dir.mkdir(exist_ok=True)
    data_model_dir.mkdir(exist_ok=True)

    model_dir = Path(MODELS_PATH) / 'v3'
    model_dir.mkdir(exist_ok=True)
