...
from scripts.config import (
    ...
    COUNTRY_DICT,
    TIMEZONE,
    PREPROCESSING_CONFIG_V2 as PREPROCESSING_CONFIG,
    SECONDS_PER_DAY,
    SECONDS_PER_WEEK,
...
def create_windows(
    ...
    with open(MODELS_PATH / 'v2' / 'features_info.json', 'w') as f:
...
def main(
    ...
    data_model_dir = data_dir / 'v2'
    data_dir.mkdir(exist_ok=True)
    data_model_dir.mkdir(exist_ok=True)

    model_dir = Path(MODELS_PATH) / 'v2'
    model_dir.mkdir(exist_ok=True)
