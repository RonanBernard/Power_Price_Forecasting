...
def create_dnn_dataset(
    sqlite_path: str,
    output_path: Optional[str] = None
) -> pd.DataFrame:
    """
    Create a dataset for a DNN model by merging ENTSOE prices, load forecast, and wind/solar forecast data.
    The dataset will be used to train a model to predict the price of electricity.
    ...
    non_numeric_cols = ['country', 'unit_price', 'unit_load', 'unit_generation']
    pivot_columns = [
